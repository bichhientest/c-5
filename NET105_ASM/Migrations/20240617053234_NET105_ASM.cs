...
{
    /// <inheritdoc />
    public partial class NET105_ASM : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderComboDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderComboDetails_Combos_ComboId",
                        column: x => x.ComboId,
                        principalTable: "Combos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderComboDetails_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderComboDetails_ComboId",
                table: "OrderComboDetails",
                column: "ComboId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderComboDetails_OrderId",
                table: "OrderComboDetails",
                column: "OrderId");
